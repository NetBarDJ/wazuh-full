...
export class WzDatePicker extends Component {
  commonDurationRanges = [
    { "start": "now/d", "end": "now/d", "label": i18n.translate('public.components.date.picker.d', {
        defaultMessage: 'Today',
      }) },
    { "start": "now/w", "end": "now/w", "label": i18n.translate('public.components.date.picker.w', {
        defaultMessage: 'This week',
      }) },
    { "start": "now-15m", "end": "now", "label": i18n.translate('public.components.date.picker.15m', {
        defaultMessage: 'Last 15 minutes',
      }) },
    { "start": "now-30m", "end": "now", "label": i18n.translate('public.components.date.picker.30m', {
        defaultMessage: 'Last 30 minutes',
      }) },
    { "start": "now-1h", "end": "now", "label": i18n.translate('public.components.date.picker.1h', {
        defaultMessage: 'Last 1 hour',
      }) },
    { "start": "now-24h", "end": "now", "label": i18n.translate('public.components.date.picker.24h', {
        defaultMessage: 'Last 24 hours',
      }) },
    { "start": "now-7d", "end": "now", "label": i18n.translate('public.components.date.picker.7d', {
        defaultMessage: 'Last 7 days',
      }) },
    { "start": "now-30d", "end": "now", "label": i18n.translate('public.components.date.picker.30d', {
        defaultMessage: 'Last 30 days',
      }) },
    { "start": "now-90d", "end": "now", "label": i18n.translate('public.components.date.picker.90d', {
        defaultMessage: 'Last 90 days',
      }) },
    { "start": "now-1y", "end": "now", "label": i18n.translate('public.components.date.picker.1y', {
